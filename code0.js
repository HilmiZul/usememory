...
{for(var i = 0, len = gdjs.Level1Code.GDNewTiledSpriteObjects1.length ;i < len;++i) {
    gdjs.Level1Code.GDNewTiledSpriteObjects1[i].setXOffset(gdjs.Level1Code.GDNewTiledSpriteObjects1[i].getXOffset() + (3 * gdjs.evtTools.runtimeScene.getElapsedTimeInSeconds(runtimeScene)));
}
}}
